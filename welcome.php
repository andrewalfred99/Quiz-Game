...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Quiz Game</b></a>
        </div>
            ...
            <div class="col-md-12">
                ...
                <?php
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        <center><h1 class="title" style="color:#8E2DE2">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            $r=$row['sahi'];
                            $qa=$row['level'];
                            echo '<tr style="color:#8E2DE2"><td>Total Questions</td><td>'.$qa.'</td></tr>
                                <tr style="color:#8E2DE2"><td>right Answer&nbsp;<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></td><td>'.$r.'</td></tr> 
                                <tr style="color:#8E2DE2"><td>Wrong Answer&nbsp;<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></td><td>'.$w.'</td></tr>
                                <tr style="color:#8E2DE2"><td>Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
                        }
                        $q=mysqli_query($con,"SELECT * FROM rank WHERE  email='$email' " )or die('Error157');
                        while($row=mysqli_fetch_array($q) )
                        {
                            $s=$row['score'];
                            echo '<tr style="color:#8E2DE2"><td>Overall Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
                        }
                        echo '</table></div>';
                    }
                ?>
                ...
                <?php
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        ...
                        <table class="table table-striped title1" >
                        <tr style="color:#8E2DE2"><td><center><b>Rank</b></center></td><td><center><b>Name</b></center></td><td><center><b>Email</b></center></td><td><center><b>Score</b></center></td></tr>';
                        $c=0;
